...
func commentCorpus() []commentCorpusCase {
	return []commentCorpusCase{
		...
		{name: "file only comment", src: "/* only */", texts: []string{"/* only */"}, prettyMust: []string{"/* only */"}},
		...
		{name: "paren pure swc", src: "/*#__PURE__*/ (console.log('s'))", texts: []string{"/*#__PURE__*/"}, prettyMust: []string{"#__PURE__"}},
		...
		// ---- SWC fixtures ----
		{name: "swc call posts", src: "test(123/*post: 9*/, 456/*post: 10*/);", texts: []string{"/*post: 9*/", "/*post: 10*/"}, prettyMust: []string{"/*post: 9*/", "/*post: 10*/"}},
		...
		{name: "babel surrounding call", src: "foo(/*before*/ bar() /*after*/)", texts: []string{"/*before*/", "/*after*/"}, prettyMust: []string{"/*before*/", "/*after*/"}},
		...
		{name: "babel surrounding while", src: "/*a*/ while /*b*/ (1) /*c*/ { }", texts: []string{"/*a*/", "/*b*/", "/*c*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/"}},
		{name: "babel surrounding debugger", src: "/*a*/ debugger /*b*/;", texts: []string{"/*a*/", "/*b*/"}, prettyMust: []string{"/*a*/", "/*b*/"}, prettyMustNot: []string{"debugger; /*b*/"}},
		{name: "babel call trailing comma", src: "f(1, /*c*/)", texts: []string{"/*c*/"}, prettyMust: []string{"/*c*/"}},
		{name: "babel array trailing comma", src: "[1, /*c*/]", texts: []string{"/*c*/"}, prettyMust: []string{"/*c*/"}},
		{name: "babel object trailing comma", src: "({a: 1, /*c*/})", texts: []string{"/*c*/"}, prettyMust: []string{"/*c*/"}},
		{name: "babel new trailing comma", src: "new F(1, /*c*/)", texts: []string{"/*c*/"}, prettyMust: []string{"/*c*/"}},
		{name: "babel function comments", src: "function /*a*/ f /*b*/ ( /*c*/ a /*d*/ ) /*e*/ { }", texts: []string{"/*a*/", "/*b*/", "/*c*/", "/*d*/", "/*e*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/", "/*d*/", "/*e*/"}},
		{name: "babel async function", src: "async /*a*/ function /*b*/ f(){}", texts: []string{"/*a*/", "/*b*/"}, prettyMust: []string{"async /*a*/ function"}},
		{name: "babel arrow", src: "(a) /*c*/ => 1", texts: []string{"/*c*/"}, prettyMust: []string{"/*c*/"}},
		{name: "babel async arrow", src: "async /*a*/ (x) /*b*/ => x", texts: []string{"/*a*/", "/*b*/"}, prettyMust: []string{"/*a*/", "/*b*/"}},
		...
		{name: "babel try", src: "try /*a*/ { } /*b*/ catch /*c*/ (e) /*d*/ { } /*e*/ finally /*f*/ { }", texts: []string{"/*a*/", "/*b*/", "/*c*/", "/*d*/", "/*e*/", "/*f*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/", "/*d*/", "/*e*/", "/*f*/"}},
		{name: "babel sequence", src: "(a, /*c*/ b, /*d*/ c)", texts: []string{"/*c*/", "/*d*/"}, prettyMust: []string{"/*c*/", "/*d*/"}},
		{name: "babel switch fallthrough", src: "switch (x) { case 1: // fall\ncase 2: break; }", texts: []string{"// fall"}, prettyMust: []string{"// fall"}},
		...
		{name: "for header", src: "for /*a*/ (/*b*/ var i = 0; /*c*/ i < 1; /*d*/ i++) {}", texts: []string{"/*a*/", "/*b*/", "/*c*/", "/*d*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/", "/*d*/"}},
		{name: "for of", src: "for (const /*a*/ x /*b*/ of /*c*/ y) {}", texts: []string{"/*a*/", "/*b*/", "/*c*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/"}},
		{name: "labelled", src: "/*a*/ L /*b*/ : /*c*/ foo()", texts: []string{"/*a*/", "/*b*/", "/*c*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/"}},
		...
		{name: "destructure", src: "var { /*a*/ a /*b*/ = /*c*/ 1 } = o", texts: []string{"/*a*/", "/*b*/", "/*c*/"}, prettyMust: []string{"/*a*/", "/*b*/", "/*c*/"}},
